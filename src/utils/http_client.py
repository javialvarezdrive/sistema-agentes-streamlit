...
def add_agente_http(nip, nombre, apellido1, apellido2, seccion, grupo):
...
def update_agente_http(nip, nombre=None, apellido1=None, apellido2=None, seccion=None, grupo=None):
