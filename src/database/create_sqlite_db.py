...
def create_database():
    ...
    # Agentes
    agentes = [
        ('A001', 'Pedro', 'López', 'García', 'pedro@ejemplo.com', '600111222', 'A1', 'G1'),
        ('A002', 'Ana', 'Martínez', 'Rodríguez', 'ana@ejemplo.com', '600222333', 'A2', 'G2'),
        ('A003', 'Miguel', 'Sánchez', 'Fernández', 'miguel@ejemplo.com', '600333444', 'A3', 'G3'),
        ('A004', 'Lucía', 'Pérez', 'González', 'lucia@ejemplo.com', '600444555', 'A4', 'G4'),
        ('A005', 'David', 'García', 'Martínez', 'david@ejemplo.com', '600555666', 'A5', 'G5'),
        ('A006', 'Elena', 'Rodríguez', 'López', 'elena@ejemplo.com', '600666777', 'A6', 'G6'),
        ('A007', 'Javier', 'González', 'Sánchez', 'javier@ejemplo.com', '600777888', 'A7', 'G7'),
        ('A008', 'Carmen', 'Fernández', 'Pérez', 'carmen@ejemplo.com', '600888999', 'A8', 'G8'),
        ('A009', 'Alberto', 'Martínez', 'García', 'alberto@ejemplo.com', '600999000', 'A9', 'G9'),
        ('A010', 'Silvia', 'López', 'Rodríguez', 'silvia@ejemplo.com', '601000111', 'A10', 'G10'),
        ('A011', 'Roberto', 'Sánchez', 'González', 'roberto@ejemplo.com', '601111222', 'A11', 'G11'),
        ('A012', 'Natalia', 'Pérez', 'Fernández', 'natalia@ejemplo.com', '601222333', 'A12', 'G12'),
        ('A013', 'Francisco', 'García', 'Martínez', 'francisco@ejemplo.com', '601333444', 'A13', 'G13'),
        ('A014', 'Isabel', 'Rodríguez', 'López', 'isabel@ejemplo.com', '601444555', 'A14', 'G14'),
        ('A015', 'Alejandro', 'González', 'Sánchez', 'alejandro@ejemplo.com', '601555666', 'A15', 'G15')
    ]
    cursor.executemany('INSERT INTO agentes (nip, nombre, apellido1, apellido2, email, telefono, seccion, grupo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', agentes)
